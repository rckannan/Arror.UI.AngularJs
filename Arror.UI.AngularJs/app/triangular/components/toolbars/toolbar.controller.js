(function() {
    ...
    /* @ngInject */
    function DefaultToolbarController($scope, $rootScope, $mdMedia, $translate,$mdDialog, $state, $element, $filter, $mdUtil, $mdSidenav, $mdToast, $timeout, $document, arrBreadcrumbsService, arrSettings, arrLayout, arrException, arrHttpMenuService) {
        var vm = this;
        ...
        $scope.$on('arrExceptionEvent', function ($event, item) {
            ...
            arrHttpMenuService.PostErrors('api/ExceptionLog', item);
        });
